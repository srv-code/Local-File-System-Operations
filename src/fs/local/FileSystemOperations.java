...
public class FileSystemOperations {
	 ...
	 * */
	private void count(final String root) throws IOException {
...
//				root.listFiles()==null ? "null" : "not null");
	 ...
	 */
	private void move(final String srcPath, final String dstPath) throws IOException {
	 ...
	 */
	private void copy(final String srcPath, final String dstPath) throws IOException {
	 ...
	 */
	private void delete(final String root) throws IOException {
